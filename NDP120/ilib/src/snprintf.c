...
#if __MINGW32__  || defined(__APPLE__)
...
#if !defined(HAVE_VSNPRINTF) && !defined(HAVE_C99_VSNPRINTF) && !defined(HAVE__VSNPRINTF)
 ...
 int vasprintf(char **ptr, const char *format, va_list ap)
{
        ...
        (*ptr) = (char *)malloc((size_t)(ret+1));
        if (!*ptr) return -1;
        ret = vsnprintf(*ptr, (size_t)(ret+1), format, ap);
