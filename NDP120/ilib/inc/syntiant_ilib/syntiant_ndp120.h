...
#define NDP120_AUDIO_SAMPLE_RATE 16000
#define NDP120_AUDIO_SAMPLES_PER_WORD 2
...
/* tank setters */
enum {
    NDP120_CONFIG_SET_TANK_SAMPLETANK_MSEC = 1
};
 ...
 * @note this struct is defined the same way in packager file board_TLVs.
 */
...
enum syntiant_ndp120_posterior_config_set_e {
    ...
    NDP120_CONFIG_SET_POSTERIOR_CONFIG_SET_ADAPTIVE_THRESHOLD = 0x1000,
    /**< set the class scp adaptive threshold */
    NDP120_CONFIG_SET_POSTERIOR_CONFIG_SET_ADAPTIVE_FRAMES = 0x2000,
    /**< set adaptive frames */
    NDP120_CONFIG_SET_POSTERIOR_CONFIG_SET_ADAPTIVE_DENOMIATOR = 0x4000,
    /**< set adaptive denominator */
    NDP120_CONFIG_SET_POSTERIOR_CONFIG_SET_ADAPTIVE_MAX_UPDATES = 0x8000,
    /**< set adaptive max updates */

    NDP120_CONFIG_SET_POSTERIOR_CONFIG_SET_ALL_M
    = ((uint32_t)(NDP120_CONFIG_SET_POSTERIOR_CONFIG_SET_ADAPTIVE_MAX_UPDATES << 1) - 1)
};
...
enum syntiant_ndp120_config_other_e {
    ...
    NDP120_CONFIG_OTHER_CONFIG_POSTERIOR_HANDLER
};
